...
[![CI](https://github.com/fedora-bpf/bpf-rbacd/actions/workflows/ci.yml/badge.svg)](https://github.com/fedora-bpf/bpf-rbacd/actions/workflows/ci.yml)
...
See the [Fedora Change Proposal](../fedora-change-bpf-rbac.md) for full technical details.
...
git clone https://github.com/fedora-bpf/bpf-rbacd.git
cd bpf-rbacd
